...
if __name__ == "__main__":
    ...
    parser.add_argument("--fps", type=float, default=50, help='display fps')
    parser.add_argument("--max_step", type=int, default=1000, help='max step in a round')
    ...
    agent1_import_path = 'agent.' + args.agent1 + '.agent1'
